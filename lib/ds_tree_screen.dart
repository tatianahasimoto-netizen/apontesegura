...
const _nodes = <_N>[
  ...
  _N('PartnerButton', 'MOLECULES', ['Palette', 'Radius', 'Typography', 'Spacing']),
  _N('WalletButton', 'MOLECULES', ['Logo', 'Palette', 'Radius', 'Typography']),
  ...
  _N('FeatureDetailCard', 'MOLECULES', ['IconAccessory', 'StatusTag', 'Palette', 'Scheme', 'Radius', 'Typography', 'Spacing']),
  ...
  _N('AppListRow', 'MOLECULES',
      ['SpotIcon', 'Avatar', 'IconAccessory', 'ProgressRing', 'StatusTag', 'Action', 'IconButton', 'Checkbox', 'ToggleSwitch', 'Amount', 'Palette', 'Scheme', 'Radius', 'Typography', 'Spacing']),
  ...
  _N('PromoBanner', 'MOLECULES', ['IllustrationAccessory', 'Button', 'Palette', 'Radius', 'Typography', 'Spacing']),
  _N('NoticeBanner', 'MOLECULES', ['IllustrationAccessory', 'IconButton', 'Palette', 'Radius', 'Typography', 'Spacing']),
  _N('JourneyStep', 'MOLECULES', ['IconAccessory', 'StatusTag', 'Button', 'Palette', 'Scheme', 'Radius', 'Typography', 'Spacing']),
  _N('ProgressBar', 'MOLECULES', ['Palette', 'Scheme', 'Radius', 'Typography']),
  _N('ProgressRing', 'ATOMS', ['Palette', 'Scheme', 'Typography']),
  _N('OfflinePill', 'MOLECULES', ['IconAccessory', 'Palette', 'Radius', 'Typography', 'Spacing']),
  _N('WalletCard', 'MOLECULES', ['IconAccessory', 'Logo', 'Palette', 'Scheme', 'Radius', 'Typography', 'Spacing']),
  ...
  _N('CobrandMark', 'MOLECULES', ['Logo', 'Scheme', 'Typography', 'Spacing']),
  // ── ORGANISMS ──
  ...
  _N('ChatCompletionCard', 'ORGANISMS', ['Logo', 'StatusTag', 'Palette', 'Gradients', 'Radius', 'Elevation', 'Typography', 'Spacing']),
  _N('StatusBanner', 'ORGANISMS', ['IconAccessory', 'ProgressBar', 'Palette', 'Scheme', 'Gradients', 'Radius', 'Elevation', 'Typography', 'Spacing']),
  _N('Sheets', 'ORGANISMS',
      ['AppList', 'Button', 'Checkbox', 'FaceIdCard', 'GlassSurface', 'IconAccessory', 'Input', 'LoadingSpinner', 'NavigationTopBar', 'TopAppBar', 'WalletCard', 'Keyboard', 'BottomHomeIndicator', 'Palette', 'Scheme', 'Radius', 'Elevation', 'Typography', 'Spacing']),
  _N('PaymentSheet', 'ORGANISMS', ['Button', 'LoadingSpinner', 'Palette', 'Scheme', 'Radius', 'Spacing']),
  _N('CheckoutSheet', 'ORGANISMS', ['AppList', 'Button', 'Scheme', 'Radius', 'Spacing']),
  _N('SdkScreen', 'ORGANISMS', ['IllustrationAccessory', 'PartnerButton', 'CobrandMark', 'Palette', 'Scheme', 'Gradients', 'Typography', 'Spacing']),
  // Gramática — Surface enquadra top/content/bottom (screen/modal/sheet).
  _N('SeeAllLink', 'ATOMS', ['Scheme', 'Typography']),
  _N('CobrandEyebrow', 'MOLECULES', ['Logo', 'Scheme', 'Typography', 'Spacing']),
  _N('CobrandedBadge', 'MOLECULES', ['Logo', 'Scheme', 'Radius', 'Typography', 'Spacing']),
  ...
  _N('WalletCardStack', 'ORGANISMS', ['WalletCard', 'Scheme', 'Spacing']),
